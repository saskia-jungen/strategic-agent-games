...
def main() -> None:
    ...
    parser.add_argument(
        "--games", nargs="+",
        default=["ultimatum", "bilateral-trade", "first-price-auction", "provision-point", "dictator", "public-project", "trust", "voluntary-contribution", "insurance-moral-hazard", "principal-agent", "centipede"],
    )
